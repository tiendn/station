...
export const [useBankBalance, BankBalanceProvider] = createContext<Coins>("useBankBalance");
...
export const useTerraNativeLength = () => {
	...
	return bankBalance?.toArray().filter(({ denom }) => isDenomTerraNative(denom)).length;
};
